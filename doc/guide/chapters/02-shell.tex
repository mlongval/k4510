...
\texttt{EhBASIC PROG.BAS > VI EDITTMP.BAS} while \verb|*VI| has it --- a
trail of who started whom, with the file each one has open, LOGO's
\texttt{.LGO}, BOOK's page and CP/M or the Linux prompt on the Tube
included. And while somebody types into the machine from another
