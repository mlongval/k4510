...
\begin{aside}
\textbf{Where it is going.} This is PROG's third stage. Next come the mouse
and selection --- Shift and the arrows, the mouse to place the cursor, to
open a menu, to pick a message --- and last the interpreters: EhBASIC,
Microsoft BASIC, LOGO and Forth run on the file in front of you, their
