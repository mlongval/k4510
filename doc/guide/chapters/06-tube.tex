...
whole machine layer an update carries is under 6. On the host, \pth{tools/
get-freedoom.sh} fetches \emph{Freedoom} --- a BSD-licensed replacement for
id's data, built over twenty years to run on this engine --- into
\pth{/APPS/DOOM}. Any IWAD the engine accepts will do, including your own.
