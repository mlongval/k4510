...
#include <sys/stat.h>
#include <unistd.h>
/* [K4510] compressed images (.gz, .zip) need zlib and libzip, which the K4510
 * Linux does not carry: with LINAPPLE_NO_COMPRESSED_IMAGES they are refused
 * with a message, and everything else is as upstream has it. */
#ifndef LINAPPLE_NO_COMPRESSED_IMAGES
#include <zip.h>
#include <zlib.h>
#endif
...
#ifndef LINAPPLE_NO_COMPRESSED_IMAGES   /* [K4510] */
...
#endif /* [K4510] LINAPPLE_NO_COMPRESSED_IMAGES */
...
#ifdef LINAPPLE_NO_COMPRESSED_IMAGES
  Logger::error("[K4510] %s: compressed disk images are not supported on this build -- unpack it first", image_path);   /* [K4510] */
