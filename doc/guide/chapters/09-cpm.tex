...
the K/OS shell. Ctrl-C stops a running CP/M program that is listening
for it, as it did in 1978 --- an \verb|MBASIC| loop, say.
...
The shell can be told to treat an unknown word as a CP/M program: F12
