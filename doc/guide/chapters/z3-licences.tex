...
\section{Fonts}
\begin{itemize}[leftmargin=1.4em]
\item \textbf{unscii-8 and unscii-16} --- Ville-Matias Heikkilä.
  \pth{data/fonts/unscii/}: the upstream \verb|.hex| files and the
  \pth{font8-unscii.bin} and \pth{font16-unscii.bin} made from them.
  The machine's one screen font. \emph{Public domain.}
...
history} before it was made public. Since 2026-09-14 the machine has
one font, unscii, and reads no other: a \verb|chargen.bin| in
\pth{/SYSTEM/ETC} is ignored.
\end{aside}
...
chapter with them, and remember two things that are easy to forget: EhBASIC is
