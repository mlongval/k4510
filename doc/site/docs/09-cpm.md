...
!!! note ""
    **Edges, honestly:** line-mode programs (assemblers, compilers, MBASIC, adventures) work today, and so does the full-screen software: the console is JIM, a VT100 in hardware ([Chapter 6, The Tube](06-tube.md)). WordStar 4 on `E:` user 3 comes installed for “ANSI Standard” at 79×29 — `WS` and you are editing; Turbo Pascal 3 on `H:` user 3 needs nothing either. A program that asks its terminal type at install time wants “VT100” or “ANSI”.
