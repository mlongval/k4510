...
# (no raw sockets), and a disk that survives a reload -- what SAVE writes
# lives in the page's memory until the tab closes.  Everything else is the
...
SRC="sdl/main.c core/xemu/cpu65.c core/mem.c core/io.c core/vicky.c core/net.c core/net_wasm.c core/term.c core/state.c core/hostid.c core/ui/settings.c core/ui/menu.c core/ui/ui_draw.c sdl/host_posix.c core/opl2/fmopl.c core/opl2.c core/vice_clk.c core/sndq.c core/audio.c"
emcc -O2 -Icore -Wno-unused-function -DK4510_NOPROC -DK4510_WASM \
    ...
    --preload-file fs --exclude-file "fs/CPM/*" --exclude-file "fs/.TRASH/*" \
