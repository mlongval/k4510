...
shell is told its terminal is \textbf{xterm-color}: JIM has colour,
which \texttt{vt100}'s terminfo leaves out, and \texttt{ansi} is the
PC's ANSI.SYS, which garbles \verb|htop|. \verb|TELNET| offers the
same name first.
