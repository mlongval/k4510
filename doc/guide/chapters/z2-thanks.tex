...
whole of the machine's CP/M: a complete CP/M~2.2 with its own CCP,
...
\textbf{Ville-Matias Heikkilä} (``Viznut'') ---
\href{https://viznut.fi/unscii/}{unscii}, placed in the public domain.
It is the machine's one screen font: unscii-8 in the 240-line modes,
unscii-16 at 640$\times$480, and both in the F12 menu and the side panel.

\textbf{The Linux kernel} contributors --- the 8x8 console font
(\verb|font_8x8.c|) that got the text mode on its feet, and the 8x16 VGA
font the K4510x consoles wear.
