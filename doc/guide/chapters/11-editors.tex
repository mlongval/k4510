...
the other interpreters: EhBASIC\shipif{lang:MSBASIC}{, Microsoft BASIC},
LOGO and Forth run on the file in front of you, their errors in the same
list.
\end{aside}
...
Section~\ref{sec:basicvi} has the details for EhBASIC; BBC BASIC does the
same with \verb|*VI| and \verb|*EDIT|
(Chapter~\ref{cha:tube})\shipif{lang:MSBASIC}{, Microsoft BASIC with
\texttt{*VI} (Chapter~\ref{cha:msbasic})}, and LOGO with
...
file: a \texttt{.BAS} is EhBASIC's\shipif{lang:MSBASIC}{ or Microsoft's}, a \texttt{.BBC} is BBC
