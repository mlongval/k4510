...
Host  
on the K4510’s own Linux only: the computer’s name, its network address and Tailscale’s, a *Wi-Fi / network setup* row that opens the network settings on a spare console, and a row that telnets into the Linux for you.
